...
odoo.define("pos_product_available_negative.tour", function(require) {
    ...
    function change_cashier(cashier) {
        return [
            ...
            },
            {
                ...
                trigger:
                    '.popup.popup-selection:contains("Change Cashier") div[data-item-index]:contains("' +
                    cashier +
                    '")',
            },
        ];
    ...
    function payment(cashier, pay_method) {
        return [
            ...
            },
            {
                ...
                trigger:
                    '.modal-dialog.cashier:not(.oe_hidden) .cashier .selection-item:contains("' +
                    cashier +
                    '"), .payment-screen:not(.oe_hidden) h1:contains("Payment")',
            },
            {
    ...
    function check_popup() {
        return [
            {
                trigger:
                    '.popup.popup-selection:contains("out-of-stock product"):not("oe_hidden") .button.cancel',
    ...
    tour.register(
        "tour_pos_product_available_negative",
        {test: true, url: "/web"},
        steps
    );
});
