...
odoo.define("pos_debt_sync", function(require) {
    ...
    var longpolling = require('pos_longpolling.pos');
    ...
    models.PosModel = models.PosModel.extend({
        ...
        after_restoring_connection: function() {
            ...
            if (
                client_list_screen &&
                client_list_screen.clientlist_screen_is_opened()
            ) {
                partner =
                    client_list_screen.new_client ||
                    client_list_screen.pos.get_client();
                if (partner) {
