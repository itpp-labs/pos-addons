...
class Param(models.Model):
    ...
    def get_wechat_miniprogram_pay_object(self):
        ...
        _logger.debug(
            "WeChat Credentials: miniprogram_app_id=%s, miniprogram_app_secret=%s, mch_id=%s, sub_mch_id=%s, sandbox mode is %s",
    ...
    def get_openid_url(self, code):
        ...
        url = "{}?{}".format(base_url, werkzeug.urls.url_encode(param))
