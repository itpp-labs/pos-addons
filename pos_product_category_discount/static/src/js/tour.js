odoo.define("pos_product_category_discount.tour", function(require) {
    "use strict";
    ...
    var steps = [
        ...
        {
            trigger:
                '.o_pos_kanban .o_kanban_record:contains("Shop") button.oe_kanban_action_button',
            content:
    ...
    tour.register(
        "pos_product_category_discount_tour",
        {test: true, url: "/web"},
        steps
    );
});
