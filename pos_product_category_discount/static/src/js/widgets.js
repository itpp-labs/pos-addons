    ...
    discount.DiscountButton.include({
        ...
        apply_discount: function(pc) {
            ...
            if (pc !== null) {
                ...
                var not_discount_product = order
                    .get_orderlines()
        ...
        update_summary: function() {
            ...
            if (this.el.querySelector(".summary .total .discount .value")) {
                ...
                this.el.querySelector(
                    ".summary .total .discount .value"
                ).textContent = this.format_currency(discount);
            }
        },
        ...
        .widget.include({
                ...
                if (this.new_client) {
                    if (
                        (this.has_client_changed() ||
                            this.has_discount_program_changed()) &&
                        this.new_client.discount_program_id
                    ) {
                        this.pos.set_discount_categories_by_program_id(
                            this.new_client.discount_program_id[0]
                        );
                    }
            ...
            has_discount_program_changed: function() {
                if (
                    this.old_client &&
                    this.new_client &&
                    this.old_client.id === this.new_client.id
                ) {
                    if (
                        this.old_client.discount_program_id &&
                        this.new_client.discount_program_id &&
                        this.old_client.discount_program_id[0] ===
                            this.new_client.discount_program_id[0]
                    ) {
                        return false;
                    }
