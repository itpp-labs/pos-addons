...
* `IT-Projects LLC <https://it-projects.info>`__
      ...
      at `odoo apps store <https://apps.odoo.com/apps/modules/13.0/pos_multi_session_restaurant/>`__.
...
HTML Description: https://apps.odoo.com/apps/modules/13.0/pos_multi_session_restaurant/

Usage instructions: `<doc/index.rst>`_

Changelog: `<doc/changelog.rst>`_

Notifications on updates: `via Atom <https://github.com/it-projects-llc/pos-addons/commits/13.0/pos_multi_session_restaurant.atom>`_, `by Email <https://blogtrottr.com/?subscribe=https://github.com/it-projects-llc/pos-addons/commits/13.0/pos_multi_session_restaurant.atom>`_
