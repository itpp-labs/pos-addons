...
odoo.define("pos_invoice_pay.tour", function(require) {
    ...
    function select_invoice() {
        return [
            ...
            },
            {
                ...
                trigger:
                    '.modal-dialog:not(.oe_hidden) .popup-selection .selection-item:contains("Administrator"), .invoice-list-screen:not(".oe_hidden") .list thead:first()',
            },
            {
    ...
    function max_payment(pay_method) {
        return [
            ...
            {
                trigger:
                    '.invoice-payment-screen:not(".oe_hidden") .numpad button[data-action="9"]',
