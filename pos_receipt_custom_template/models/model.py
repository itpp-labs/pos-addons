...
class PosCustomReceipt(models.Model):
    ...
    type = fields.Selection(
        string="Type", selection=[("receipt", "Receipt"), ("ticket", "Ticket")]
    )
...
class PosConfig(models.Model):
    ...
    show_second_product_name_in_receipt = fields.Boolean(
        string="Display Second Product Name", default=False
    )
    show_discount_in_receipt = fields.Boolean(
        string="Display discount on the ticket",
        default=True,
    ...
    custom_ticket_id = fields.Many2one(
        "pos.custom_receipt",
        string="Custom Ticket Template",
    ...
    custom_xml_receipt_id = fields.Many2one(
        "pos.custom_receipt",
        string="Custom PosBox Receipt Template",
