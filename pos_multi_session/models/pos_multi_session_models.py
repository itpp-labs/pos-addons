...
class PosConfig(models.Model):
    ...
    multi_session_block_exist_order = fields.Boolean('Block existing order', default=True, help='Block the existing order if the POS does not have a connection to the server')
