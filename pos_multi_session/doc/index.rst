...
The pos_multi_session is compatible with all IT-Projects modules. It may not be compatible with other thir-party modules that add additional data to Order or Orderline js model. For such cases we provide developer instruction how to add compatibility (available in README file).
