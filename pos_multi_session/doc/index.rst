...
Same POS may be simultaneously opened on the different devices, but be sure you do not launch them simultaneously.
Wait for the POS loading on one device before start it on the another.
It may cause some troubles with losing an order data. For more information see https://github.com/odoo/odoo/pull/24486
