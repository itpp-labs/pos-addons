        ...
        change_screen_type: function(current_screen) {
            ...
            if (current_screen === "clientlist") {
                ...
                */
                ...
                var client_detail_height = $(
                    ".clientlist-screen .subwindow.collapsed"
                ).height();
                var new_height =
                    $(".clientlist-screen .full-content").height() -
                    client_detail_height -
                    2;
                ...
                if (!this.pos.iOS) {
                    var el = $(
                        ".clientlist-screen .subwindow-container-fix.touch-scrollable.scrollable-y"
                    );
                ...
                var paymentmethods = $(
                    ".payment-screen .paymentmethods-container"
                ).height();
                ...
                $(".paymentlines-container").css({
                    height: height - paymentmethods - numpad - 20,
                });
                // Add custom scrolling
