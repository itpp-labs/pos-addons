...
class ResUsers(models.Model):
    ...
    allow_delete_order = fields.Boolean(
        "Allow remove non-empty order", default=True
    )
    ...
    allow_delete_order_line = fields.Boolean(
        "Allow remove order line", default=True
    )
    allow_create_order_line = fields.Boolean(
        "Allow create order line", default=True
    )
