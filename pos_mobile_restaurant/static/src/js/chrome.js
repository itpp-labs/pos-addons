odoo.define("pos_mobile_restaurant.chrome", function(require) {
    ...
    chrome.Chrome.include({
        ...
        build_widgets: function() {
            ...
            // Floor screen swiper
            this.swiper_floor_screen = new window.Swiper(
                ".swiper-container-floor-screen",
                {
                    slidesPerView: "auto",
                    initialSlide: 1,
                    resistanceRatio: 0,
            ...
            order_button.detach();
            $(".mobile-order-container .mobile-search-bar .searchbox").prepend(
                order_button
            );
    ...
    chrome.OrderSelectorWidget.include({
        scroll_to_selected_order: function() {
            if (this.pos.table) {
                ...
                var floor_button_width =
                    $(".pos-rightheader .floor-button").width() + 50;
                $(".pos-rightheader .orders.touch-scrollable").scrollLeft(
                    floor_button_width + 105 * width
                );
            } else {
                this._super();
            }
