    ...
    var HistoryTour = core.Class.extend({
        ...
        add_product_to_order: function(product_name) {
            ...
            return [
                {
                    trigger:
                        '.product-list .product-name:contains("' + product_name + '")',
        ...
        orders_history: function(product_name) {
            ...
            return [
                ...
                {
                    trigger:
                        ".line-element-container:first .line-line:contains(" +
                        product_name +
                        ")",
                    run: function() {
                        // It's a check
        ...
        open_pos: function() {
            ...
            ].concat(this.select_table(20000));
        },
        ...
        open_pos_steps: function() {
            return [].concat(this.open_pos_kanban(), this.open_pos());
        },
            ...
            return [
                {
                    ...
                    run: function() {
                        ...
                        window.posmodel
                            .on_orders_history_updates({
                                updated_orders: _.range(0, 100, 1),
                            })
                            .then(function(res) {
