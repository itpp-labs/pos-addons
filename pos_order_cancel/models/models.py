...
class PosConfig(models.Model):
    ...
    allow_cancel_deletion = fields.Boolean(string="Reason Stating are Required", help="When not active, a user will have to select predefined reasons without the possibility to cancel this action", default=True)
